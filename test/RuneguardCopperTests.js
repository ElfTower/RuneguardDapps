...
} = require('./RuneguardCopperBehaviorTests');
...
contract('ERC20', function (accounts) {
  ...
  let first = new BN (10);
  first = first.pow (new BN (18));
  let initialSupply = new BN(1200000000);
  initialSupply = initialSupply.mul (first);
  ...
  describe('_transfer', function () {
    ...
    describe('when the recipient is the zero address', function () {
      it('reverts', async function () {
        await expectRevert(this.token.transfer(ZERO_ADDRESS, initialSupply),
  ...
  describe('_approve', function () {
    ...
    describe('when the recipient is the zero address', function () {
      it('reverts', async function () {
        await expectRevert(this.token.approve(ZERO_ADDRESS, initialSupply),
